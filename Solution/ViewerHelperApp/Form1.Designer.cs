namespace ViwerSteps
{
    partial class Form1
    {
	    ...
	    private void InitializeComponent()
	    {
			...
			this.textBox1_key.Text = "CihYFJU5f6crO7GkQt58W3oHlJWm8UOd";
			// 
			...
			this.textBox_Consumer_Secret.Text = "cWJ3nqpdDpFpEWmP";
			// 
			...
			this.txtBucketName.Text = "charsintheireyes";
			// 
			// btnCreateBucket
			// 
    ...
    "mmended.";
			...
			// tags_label
			// 
			this.tags_label.Location = new System.Drawing.Point(517, 16);
			this.tags_label.Margin = new System.Windows.Forms.Padding(2, 0, 2, 0);
			this.tags_label.Name = "tags_label";
			this.tags_label.Size = new System.Drawing.Size(36, 18);
			this.tags_label.TabIndex = 21;
			this.tags_label.Text = "Tags:";
			this.tags_label.Click += new System.EventHandler(this.label5_Click);
			// 
			// tags
			// 
			this.tags.Location = new System.Drawing.Point(557, 12);
			this.tags.Margin = new System.Windows.Forms.Padding(2, 3, 2, 3);
			this.tags.Name = "tags";
			this.tags.Size = new System.Drawing.Size(175, 20);
			this.tags.TabIndex = 22;
			// 
			// Form1
			// 
